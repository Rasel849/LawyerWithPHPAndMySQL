  ...
  <div class="App">
    ...
    <div class="navbar">
      ...
      <div class="nav">
        ...
        <a href="./lawyer.php">
          ...
          ?>
        <a href="../loginPage/userloginRegistation/registation.php">
          <p>Find A Lawyer</p>
        </a>
          <?php
        } ?>
        ...
        <div id="signup-logout-btn">
          ...
          if($email)
          {
            ...
            ?>
             <a id="signup" class="signup" style="color: #fff;" href="../loginPage/userloginRegistation/registation.php">Sign up</a>
    ...
    <div class="mybody">
      ...
      <div class="grid-container">
        ...
        <div class="card" data-aos="zoom-in">
          <img src="https://www.appointy.com/online-booking-software/wp-content/uploads/2020/10/Calendar-Scheduler.svg"
            alt="Avatar" style="width: 100px" />
          <div class="container">
        ...
        <div class="card" data-aos="zoom-in">
          <img src="https://www.appointy.com/online-booking-software/wp-content/uploads/2020/10/Appointment-Alerts.svg"
            alt="Avatar" style="width: 100px" />
          <div class="container">
        ...
        <div class="card" data-aos="zoom-in">
          <img src="https://www.appointy.com/online-booking-software/wp-content/uploads/2020/10/No-show-Protection.svg"
            alt="Avatar" style="width: 100px" />
          <div class="container">
      ...
      <div class="grid-container-2" data-aos="zoom-out">
        ...
        <div class="card">
          <img src="https://www.appointy.com/online-booking-software/wp-content/uploads/2020/10/Group-Scheduling.svg"
            alt="Avatar" style="width: 100px" />
          <div class="container">
        ...
        <div class="card">
          <img src="https://www.appointy.com/online-booking-software/wp-content/uploads/2020/10/Recurring-Bookings.svg"
            alt="Avatar" style="width: 100px" />
          <div class="container">
